...
const Catpcha = require('./controller/catpcha');
...
// 验证码
router.get('/captcha/pic', Catpcha.getPicCaptcha);
router.get('/captcha/msg', Catpcha.getMsgCaptcha);
...
// 消息
router.get('/notice', Auth.userRequired, Notice.getAllMessage); // 获取所有消息
router.get('/notice/:type', Auth.userRequired, Notice.getMessageByType); // 根据类型获取消息
